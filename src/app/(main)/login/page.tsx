...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    } catch (error: unknown) { // SỬA LỖI Ở ĐÂY
          ...
          <div className="relative z-10 w-full max-w-md mx-auto">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-xl shadow-pink-500/10 p-8">
              ...
              <div className="flex justify-between items-center text-sm mt-6">
                <a href="/forgot-password" className="font-medium text-white-400 hover:text-pink-500 transition-colors">
                    Quên mật khẩu?
                </a>
                <a href="/register" className="font-semibold text-white hover:text-pink-500 transition-colors">
                    Tạo tài khoản mới
                </a>
              </div>
